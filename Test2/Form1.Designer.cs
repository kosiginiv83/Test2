namespace Test2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button1.Text = "Открытие \'Chrome\' и \'http://blog.csssr.ru/qa-engineer/\',\r\nуменьшение масштаба стр" +
    "аницы, \r\nблокировка ссылок (кроме  .graphs)";
			...
			this.button2.Size = new System.Drawing.Size(305, 25);
			this.button2.TabIndex = 1;
			this.button2.Text = "Прокликивание ссылок .graphs";
			...
			this.button6.Text = "Отображение/скрытие элементов,\r\nимеющих неадекватные размеры";
